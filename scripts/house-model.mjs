...
import {buildDoors} from '../src/doors.js';
...
export function createHouseModel({optimize=true}={}){
 ...
 buildHouse(world);buildDoors(world);buildStations(world);if(optimize)world.optimization=optimizeHouse(world);return world;
}
